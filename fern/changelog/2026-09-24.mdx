...
account. Mini (amd64 and arm64), medium and large deployments were verified end
to end on this release.

**GCP, Azure, Exoscale and Debian packages** — not yet published at 11.1.5;
they remain on 11.1.4 and will pick this up at their next release.
