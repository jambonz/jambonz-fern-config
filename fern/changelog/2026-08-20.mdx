...
**11.1.2** refreshes the media stack — **drachtio 10.1.3** and **mediajam 0.5.4** —
and adds **nineninesix.ai** text-to-speech end to end. Calls can now be routed to
...
**Azure and GCP** — images for 11.1.2 are not published yet; 11.1.1 remains the
current release on those platforms.
