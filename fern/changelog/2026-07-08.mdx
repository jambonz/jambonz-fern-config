...
(separate license required from Krisp when self hosting). This is the biggest architectural change in the 
platform's history and is the reason 11.0.0 is a major-version bump.
