...
|recognizer|speech recognition parameters, used as per [gather](/verbs/verbs/gather) and [transcribe](/verbs/verbs/transcribe)|no, default=app defaults|
