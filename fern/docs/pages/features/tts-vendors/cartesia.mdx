...
Cartesia's tuning is passed in `synthesizer.options`. Which fields take effect depends on the model family, because Cartesia moved these controls between API shapes across versions.
