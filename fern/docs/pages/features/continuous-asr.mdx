---
title: Continous ASR
description: Configure continuous ASR in jambonz to transcribe speech throughout a call instead of in single turns. Setup and tuning parameters.
hidden: false
---
...
Continuous ASR applies to the [recognizer](/verbs/verbs/recognizer) verb and provides the ability to specify some additional options that help ensure the collection of the full customer pin in the example above. Two additional options are provided:
