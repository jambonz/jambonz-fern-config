...
| Model | When to use |
|---|---|
| `gpt-4o-mini` | Default for voice agents — fast, cheap, tool-capable |
| `gpt-4o` | Higher reasoning quality at higher cost |
| `gpt-4-turbo` | Long-context conversations |
| `o1-preview`, `o1-mini` | Reasoning-heavy single-turn tasks (no tools, no streaming — limited fit for voice) |
