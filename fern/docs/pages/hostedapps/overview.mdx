...
your application specific confufuration within the Jambonz portal.

These applications cover the common use cases and privude a limited amount of customisation through settings, if you require a more complicated
customisation you will still need to develop your own application. However the source code for these hosted applications is always availble in our GitHub repoistory
for you to expand upon.

If you experience any issues using a hosted applicaiton please email support@jambonz.org with a call_sid and date/time of an example call along with a description of the issue.
