---
title: Node.JS Websocket SDK
slug: nodeclientws
description: Build real-time voice applications with the jambonz Node.js WebSocket SDK. Handle call events, stream audio, and control calls in code.
layout: page
---

<Note>
This SDK (`@jambonz/node-client-ws`) is deprecated. New projects should use [`@jambonz/sdk`](/sdks/node-sdk), which provides a unified package for both webhook and WebSocket transports.
</Note>
