...
LLM (in this case gpt-4o-realtime-preview-2024-10-01) in the `llmOptions` property.
...
(The only exception is the [response.audio.delta](https://platform.openai.com/docs/api-reference/realtime-server-events/response/audio/delta) 
server event, because this contains actual audio content that jambonz itself processes). 
