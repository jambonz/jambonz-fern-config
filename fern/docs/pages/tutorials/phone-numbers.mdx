...
different applications based on phone numbers.  So after [creating a carrier](/tutorials/using-the-jambonz-portal/basic-concepts/creating-carriers),
...
Check out [this article](/tutorials/using-the-jambonz-portal/basic-concepts/how-inbound-call-routing-works).
