...
jambonz natively supports a large number of [STT](/verbs/verbs/recognizer) and [TTS](/verbs/verbs/say) speech providers out of the box, but if you want to use a speech provider that we don't support: no propblem! You can also add support for new speech vendors using our Speech APIs:
