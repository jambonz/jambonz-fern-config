...
description: Learn how jambonz works as a self-hosted programmable voice platform, from SIP carriers and call routing to verbs and voice AI applications.
---
...
These are actions that you want jambonz to perform. Your application sends lists of verbs to jambonz, receives events and 
