...
jambonz also provides a [REST API](xs/reference/introduction) that allows developers to generate outbound dialing campaigns, modify a call 
...
<Frame caption="Webrtc clients are supported">
  <img src="../../assets/images/chrome-dialer.jpg" alt="Webphone" width="500"/>
</Frame>
