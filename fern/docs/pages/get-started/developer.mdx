...
- Give your application a name, then put your websocket URL in both the `Calling webhook` and `Call status webhook` fields. Your websocket URL needs to start with "wws://"
