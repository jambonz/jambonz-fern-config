...
Many customers, however, prefer to self host jambonz on their own cloud or infrastructure. 
...
ongoing support and maintenance.  The jambonz project is largely funded by our support services, 
