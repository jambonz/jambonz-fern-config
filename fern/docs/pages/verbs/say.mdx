---
title: Say
subtitle: Send synthesized speech to the remote party.
hide-toc: true
---
...
| synthesizer.vendor | speech vendor to use (see list below, along with any others you add via the [custom speech API](/guides/speech-providers/custom-speech-api))| no |
