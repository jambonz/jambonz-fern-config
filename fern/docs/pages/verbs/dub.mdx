...
Additionally, the volume (gain) of the inserted audio may be adjusted up or down.  As well, the [config.boostAudioSignal](/verbs/verbs/config) allows the volume in the main conversational channel to be adjusted as well.
...
See [Using dub tracks](/guides/features/using-dub-tracks) for more information.
