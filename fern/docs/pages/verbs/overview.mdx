---
title: Overview
description: Reference for every jambonz verb used to control calls, from dial and gather to transcribe and listen. See syntax, parameters, and usage examples.
---
...
> You can develop your webapp using whatever language or framework you like, but the quickest way to scaffold up a webapp is by using our [Node.js framework](/sdks/nodeclient)
