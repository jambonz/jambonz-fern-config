...
| anchorMedia | if true, jambonz will not release the media from feature server for the bridged call. [See here](/guides/features/controlling-media-path-during-call) for details. Default: false | no |
...
For more details on controlling the media path during a call, please see [Controlling media path during call](/guides/features/controlling-media-path-during-call).
