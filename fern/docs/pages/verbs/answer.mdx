---
title: Answer
subtitle: Answers an incoming call by sending a SIP 200 OK.
hide-toc: true
---

There are no attributes in the `answer` verb.

<Note>
It is not usually necessary to use the `answer` verb, as jambonz automatically answers the call 
