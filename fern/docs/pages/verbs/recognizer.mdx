...
| asrTimeout|timeout value for [continuous ASR feature](/guides/features/continous-asr)| no |
| asrDtmfTerminationDigit|DMTF key that terminates [continuous ASR feature](/guides/features/continous-asr)| no |
...
Note: Microsoft supports [on-prem and private link options](/guides/speech-providers/azure-private-link) for deploying the speech service in addition to the hosted Microsoft service.
