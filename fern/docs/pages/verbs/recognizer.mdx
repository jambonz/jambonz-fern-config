---
title: Recognizer
subtitle: Customize speech recognition in a `gather` or `transcribe` verb
---
...
<ParamField path="vendor" type="string" required={false}>
...
<ParamField path="azureOptions" type="object" required={false}>
  Azure-specific speech recognition options (see below).
</ParamField>

<ParamField path="deepgramOptions" type="object" required={false}>
  Deepgram-specific speech recognition options (see below).
</ParamField>

<ParamField path="ibmOptions" type="object" required={false}>
  IBM Watson-specific speech recognition options (see below).
</ParamField>

<ParamField path="nuanceOptions" type="object" required={false}>
  Nuance-specific speech recognition options (see below).
</ParamField>

<ParamField path="nvidiaOptions" type="object" required={false}>
  Nvidia-specific speech recognition options (see below).
</ParamField>

<ParamField path="sonioxOptions" type="object" required={false}>
  Soniox-specific speech recognition options (see below).
</ParamField>
...
<ParamField path="utteranceEndMs" type="number" required={false}>
  (Added in `08.5`) A number of milliseconds of silence that Deepgram will wait  
...
`speechmaticsOptions` is an object with the following properties. Please refer to the [Soniox Documentation](https://soniox.com/docs/) for detailed descriptions. This option is available in jambonz 0.8.2 or above.
