...
<AccordionGroup>
  ...
  <Accordion title="openaiOptions">
    ...
    <ParamField path="promptTemplates" type="object" required={false}>
      Templates that can be used to dynamically construct the prompt to be sent to OpenAI. See [here](/guides/features/using-open-ai-stt) for details on constructing prompts.
    </ParamField>
