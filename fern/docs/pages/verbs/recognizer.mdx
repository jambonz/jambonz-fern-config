...
<AccordionGroup>
  ...
  <Accordion title="googleOptions">
    ...
    <ParamField path="customVocabulary" type="array" required={false}>
      Up to 1000 terms, acronyms, brand names or proper nouns to bias recognition towards, for the gemini models only. Example: `["jambonz", "drachtio"]`. When omitted, the recognizer's `hints` are used instead.
    </ParamField>
