---
title: Recognizer
subtitle: A **property** that can be used in verbs like `gather` and `transcribe`, or in the `amd` feature (answering machine detection [](https://docs.jambonz.org/guides/features/answering-machine-detection)) to override the application default recognizer settings.
---
