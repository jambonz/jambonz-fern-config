...
<ParamField path="llm.vendor" type="string" required={true}>
  LLM vendor id. One of: `anthropic`, `azure-openai`, `baseten`, `bedrock`, `deepseek`, `google`, `groq`, `huggingface`, `moonshot`, `openai`, `vertex-gemini`, `vertex-openai`, `zai`. See [Bring Your Own LLM](/guides/features/bring-your-own-llm) for setup of each.
</ParamField>
