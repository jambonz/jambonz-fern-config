...
<ParamField path="llm.vendor" type="string" required={true}>
  LLM vendor id. One of: `openai`, `anthropic`, `google`, `vertex-gemini`, `vertex-openai`, `bedrock`, `deepseek`, `baseten`, `azure-openai`, `groq`, `huggingface`. See [Bring Your Own LLM](/guides/features/bring-your-own-llm) for setup of each.
</ParamField>
...
| Baseten | `baseten` | `deepseek-ai/DeepSeek-V4-Pro`, `zai-org/GLM-5`, `moonshotai/Kimi-K2.6`, `openai/gpt-oss-120b` |
