...
## Canceling a license
To cancel a license, log into the licensing portal and click on the dropdown menu for the domain with the 
...
and the jambonz system will revert to unlicensed status. 
There will be no further charges applied to your payment method.
