...
## Architecture
The architecture of your self-hosted jambonz deployment will depend on the deployment size you choose.
In every case, the jambonz system consists of several key components:
...
- **Feature Server**: The central application processing logic that connects to speech and AI services as well as your application.
